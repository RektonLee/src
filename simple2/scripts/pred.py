...
# 配置
dataset_path = "/home/lizihao/Work/enzyme_prediction/src/simple2/data/processed/example.pt"
...
df.to_csv(f"{base_dir}/val_pred_results_EG.csv", index=False)
print(f"✅ 导出完成: {base_dir}/val_pred_results.csv")